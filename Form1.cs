...
namespace WATCH
{
    public partial class Form1 : Form
    {
        ...
        {
            ttInfo.SetToolTip(this.pictureBox1, DateTime.Today.ToShortDateString());
            ttInfo.SetToolTip(this.label1, DateTime.Today.ToShortDateString());
            ApplyChanges();
            if (Properties.Settings.Default.View) RunAn();
            else RunDig();
        }
        //
        // Смена режима при двойном щелчке
        ...
        private void cmsTrayAbout_Click(object sender, EventArgs e)
        {
            ...
            if (K2 == 1)
            {
                MessageBox.Show(this, "Программа 'Small clock' разработана в 2011 году. Подробности на сайте www.sacret.ru",
